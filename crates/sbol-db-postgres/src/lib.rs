...
pub use repo::{
    ...
    PgClusterStore, PgPageRankStore, PgSqlConsole, PgStatsRepository, PgTokenStore, PgUserStore,
    ProjectionEvent, ProjectionEventRepository, RecordedValidation, SbolObjectRepository,
    SequenceSearchRepository, SlowQuery, TableColumn, TableSchema, TableStats, TripleRepository,
