...
use sbol_db_search::VectorIndexMaintainer;
...
pub struct Worker {
    ...
    vector_index: Option<Arc<VectorIndexMaintainer>>,
...
impl Worker {
    ...
    pub fn with_vector_index(mut self, vector_index: Arc<VectorIndexMaintainer>) -> Self {
